...
if st.button('Recommend'):
    ...
    for i,j in zip(recommendation, posters):
        ...
        try:
            ...
            r = requests.get('https://media.istockphoto.com/vectors/page-not-found-error-with-film-flap-design-vector-id1265221960?k=20&m=1265221960&s=170667a&w=0&h=jCITUlo5a7s5fue3XrX2WB8FOK9VnbaWeLCHB8Ovj-c=')
            img = Image.open(BytesIO(r.content))
            cc.image(resizedImg, caption=i)
#------------------------------------------------------------------------------------------------------------------------
